...
<head>
    ...
    <style>
        ...
        .stats-didi { color: #00ff88; font-size: 0.9rem; font-weight: bold; letter-spacing: 1px; margin: 15px 0; }
...
<body>
    <div class="container">
        ...
        <div class="grid-links">
            <a href="https://open.spotify.com" target="_blank" class="btn spotify">🎧 Spotify Oficial</a>
